...
var defaultConfig = {
  ...
  autoDealPx: ['font-size'], // fauzzy matching
  // autoDealNo: ['border-radius', 'border', 'box-shadow', 'min-width', 'min-height', 'max-width', 'max-height'], //reg
  autoDealNo: ['border', 'shadow', 'min', 'max'], // fauzzy matching
  appendAutoDealPx: [], // fauzzy matching
  appendAutoDealNo: [] // fauzzy matching
};
...
Px2rem.prototype.generateRem = function (cssText) {
  ...
  function processRules(rules, noDealPx) {
    //keyframes and media do not support `force px` comment and autoDealPx
